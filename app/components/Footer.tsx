                                ...
                                <AnimatedEntrance {...ANIMATION_PRESETS.TEXT_FADE_LEFT} delay={200}>
                                    <div className="text-center md:text-left">
                                        <h2 className="text-lg sm:text-xl md:text-2xl font-bold mb-2 sm:mb-3 md:mb-4 leading-tight">
                                            Get Involved in Imo&apos;s Development
                                        </h2>
                                        <p className="max-w-lg opacity-70 text-sm sm:text-base leading-relaxed">
                                            Partner with us to drive critical infrastructure and development initiatives across Imo State through the Ministry of Special Projects.
                                        </p>
                                    </div>
                                </AnimatedEntrance>
                            ...
                            <div className="sm:col-span-2 md:col-span-1">
                                <Link href="/" className="group cursor-pointer">
                                    <div className="flex flex-col sm:flex-row items-start sm:items-center mb-4 sm:mb-6">
                                        ...
                                        <span className="text-base sm:text-lg md:text-xl font-bold flex-1 leading-tight transition-colors duration-300 group-hover:text-green-300">Ministry of Special Projects</span>
                                    </div>
                                </Link>
                                <p className="text-gray-300 leading-relaxed text-sm sm:text-base hover:text-gray-200 transition-colors duration-300">
                                    The Ministry of Special Projects leads Imo State&apos;s efforts in driving critical infrastructure and development initiatives, working across diverse sectors to deliver impactful projects that improve lives and communities.
                                </p>
                            </div>
                        </AnimatedEntrance>
                        ...
                        <AnimatedEntrance {...ANIMATION_PRESETS.CARD_FADE_UP} delay={STAGGER_DELAYS.MEDIUM[3]}>
                            <div>
                                ...
                                <div className="mt-4 sm:mt-6 space-y-1 sm:space-y-2 text-xs sm:text-sm text-gray-300 grid">
                                    <a href="tel:08143975074" className="hover:text-green-300 transition-colors duration-300 cursor-pointer">0814 397 5074</a>
                                    <a href="mailto:imost.ministryofspecialduties@gmail.com" className="hover:text-green-300 transition-colors duration-300 cursor-pointer">imost.ministryofspecialduties@gmail.com</a>
                                    <p className="leading-relaxed hover:text-gray-200 transition-colors duration-300">
                                        Ministry of Special Duties, block 10, State Secretariat Complex, Imo, Nigeria
                                    </p>
                                    <a href="https://www.facebook.com/p/Ministry-of-Special-Duties-Imo-State-100095781721605/?locale=ga_IE" target="_blank" rel="noopener noreferrer" className="hover:text-green-300 transition-colors duration-300 cursor-pointer block">
                                        Facebook
                                    </a>
                                </div>
                            </div>
